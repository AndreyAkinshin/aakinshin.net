...
namespace Efficiency
{
    class Program
    {
        static void Main()
        {
            // var d = new BetaDistribution(2, 10);
            // var s = new Sample(d.Random().Next(9));
            // var hd = new HarrellDavisQuantileEstimator();
            // var thd4 = new KosQuantileEstimator(4, KosQuantileEstimator.Type.Thd);
            // var b6 = new KosQuantileEstimator(6, KosQuantileEstimator.Type.Beta);
            // var thd6 = new KosQuantileEstimator(6, KosQuantileEstimator.Type.Thd);
            // var thd16 = new KosQuantileEstimator(16, KosQuantileEstimator.Type.Thd);
            // var p = 0.5;
            // Console.WriteLine("True  : " + d.Quantile(p));
            // Console.WriteLine("THD4  : " + thd4.GetQuantile(s, p));
            // Console.WriteLine("HD    : " + hd.GetQuantile(s, p));
            // Console.WriteLine("B6    : " + b6.GetQuantile(s, p));
            // Console.WriteLine("THD6  : " + thd6.GetQuantile(s, p));
            // Console.WriteLine("THD16 : " + thd16.GetQuantile(s, p));
            new Program().Run();
        }
        ...
        private void Simulate()
        {
            ...
            int[] sampleSizes = GenerateSequence(Settings.MinSampleSize, Settings.MaxSampleSize, Settings.SampleSizeStep).ToArray();
