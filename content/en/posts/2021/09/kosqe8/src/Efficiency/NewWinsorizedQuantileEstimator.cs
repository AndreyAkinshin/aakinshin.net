...
{
    public class NewWinsorizedQuantileEstimator : IQuantileEstimator
    {
        private readonly TrimmingStrategy trimmingStrategy;

        public NewWinsorizedQuantileEstimator(TrimmingStrategy trimmingStrategy)
        {
        ...
        public string Alias => "WHD-" + trimmingStrategy.Name;
    }
}