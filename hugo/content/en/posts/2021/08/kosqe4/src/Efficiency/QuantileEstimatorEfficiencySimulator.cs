...
namespace Efficiency
{
       public class QuantileEstimatorEfficiencySimulator
    {
        ...
        public class Item
        {
            ...
            private static readonly IQuantileEstimator EfficiencyEstimator = new TrimmedHarrellDavisQuantileEstimator(0.1);
            ...
            internal void Process(int iterationCount, IQuantileEstimator baselineEstimator)
            {
                ...
                double[] efficiencies = new double[Settings.EfficiencyProbeCount];
                ...
                for (int i = 0; i < efficiencies.Length; i++)
                {
                    ...
                    {
                        var data = randomGenerator.Next(SampleSize);
                        Array.Sort(data);
