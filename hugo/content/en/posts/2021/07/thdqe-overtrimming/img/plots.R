...
for (name in names) {
  ...
  # draw("a", c("THD|0.01", "THD|0.05"), main.ns)
  # draw("b", c("THD|0.05", "THD|0.1"), main.ns)
  # draw("c", c("THD|0.1", "THD|0.2"), main.ns)
  # draw("d", c("THD|0.2", "THD|0.3"), main.ns)
  # draw("e", c("THD|0.3", "THD|0.4"), main.ns)
  # draw("f", c("THD|0.4", "THD|0.5"), main.ns)
  # draw("g", c("THD|0.01", "THD|0.5"), main.ns)
